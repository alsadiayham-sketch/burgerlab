(function (global) {
    ...
    var PROJECT_ID = 'burgerlab';
    var projectRef = rawDb.collection('projects').doc(PROJECT_ID);
    var db = {
        collection: function (name) { return projectRef.collection(name); },
        batch: function () { return rawDb.batch(); },
        runTransaction: function (fn) { return rawDb.runTransaction(fn); }
    };
    ...
    global.dimaFirebase = {
        app: firebase.app(), db: db, rawDb: rawDb,
